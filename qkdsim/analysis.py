...
def main():
    ...
    return
def efficiency_vs_distance():
    x = np.linspace(600, 1200, 100)
    effQ = -(0.025*x) -20
    effF = -(0.2*x) -10
    plot_efficiency_vs_distance(x, effQ,effF)
    return
...
def plot_key_error_vs_eve_p_meas(x, error, initial_key_length):
    ...
    fileName = "C:/Users/Emoli-PC/Python/qkdv1/Output/key_error_vs_eve_p_meas.png"
    plt.savefig(  fileName, format="png" )
    return

def plot_efficiency_vs_distance(x, effQ,effF):
    plt.figure()
    plt.plot(x, effQ, '*')
    plt.plot(x,effF, '*')
    ...
    fileName = "C:/Users/Emoli-PC/Python/qkdv1/Output/efficiency_vs_distance.png"
    plt.savefig(  fileName, format="png" )
    return
